...
public class AccountClientTests {
	...
	public void listAccounts() {
		// TODO-03: Run this test. Remove the @Disabled on this test method. Then, use the restTemplate to retrieve an array containing all Account instances. Use BASE_URL to help define the URL you need: BASE_URL + "/..."
	...
	public void getAccount() {
		// TODO-05: Run this test. Remove the @Disabled on this test method. Then, use the restTemplate to retrieve the Account with id 0 using a URI template.
		// - Run the test and ensure that it passes.
	...
	public void createAccount() {
		...
		//	TODO-08: Create a new Account. Remove the @Disabled on this test method. Create a new Account by POSTing to the right URL and store its location in a variable. Note that 'RestTemplate' has two methods for this. Use the one that returns the location of the newly created resource and assign that to a variable.
	...
	public void addAndDeleteBeneficiary() {
		...
		// TODO-13: Create a new Beneficiary. Remove the @Disabled on this test method. Create a new Beneficiary called "David" for the account with id 1. POST the String "David" to the "/accounts/{accountId}/beneficiaries" URL. Store the returned location URI in a variable.
